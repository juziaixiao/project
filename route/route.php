 ...
 */
//index
Route::get('admin/welcome', 'admin/index/index');
Route::get('admin/login', 'admin/login/login');
Route::get('admin/logout', 'admin/login/logout');
Route::post('admin/login/tologin', 'admin/login/tologin');
//user
Route::get('admin/user/userlist', 'admin/user/index');
//images
Route::get('admin/images/index', 'admin/images/imagelist');
